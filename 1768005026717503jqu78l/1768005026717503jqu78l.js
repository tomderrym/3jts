// Standalone 1768005026717503jqu78l Block
...
export default function 1768005026717503jqu78l({ title = '1768005026717503jqu78l', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
