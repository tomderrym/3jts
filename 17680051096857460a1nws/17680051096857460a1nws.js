// Standalone 17680051096857460a1nws Block
...
export default function 17680051096857460a1nws({ title = '17680051096857460a1nws', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
