// Standalone 17680056692933fbiwurth Block
...
export default function 17680056692933fbiwurth({ title = '17680056692933fbiwurth', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
