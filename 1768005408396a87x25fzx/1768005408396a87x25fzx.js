// Standalone 1768005408396a87x25fzx Block
...
export default function 1768005408396a87x25fzx({ title = '1768005408396a87x25fzx', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
