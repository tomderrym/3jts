// Standalone 1768004883256s7zvuvadn Block
...
export default function 1768004883256s7zvuvadn({ title = '1768004883256s7zvuvadn', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
