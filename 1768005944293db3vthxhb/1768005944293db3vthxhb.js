// Standalone 1768005944293db3vthxhb Block
...
export default function 1768005944293db3vthxhb({ title = '1768005944293db3vthxhb', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
