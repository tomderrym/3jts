// Standalone 1768005615595tfavjqsct Block
...
export default function 1768005615595tfavjqsct({ title = '1768005615595tfavjqsct', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
