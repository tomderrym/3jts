// Standalone 17680047498377wgwtky9b Block
...
export default function 17680047498377wgwtky9b({ title = '17680047498377wgwtky9b', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
