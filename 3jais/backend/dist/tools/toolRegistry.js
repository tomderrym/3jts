...
function scanWorkspace(root, maxDepth = 1) {
    const out = [];
...
function readFileTool(root, filePath, maxBytes = 32_000) {
...
export async function invokeTool(name, args, workspaceRoot) {
    switch (name) {
        case "scan_workspace": {
