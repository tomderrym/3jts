...
export function calculatePriority(s) {
...
export function withPriorityScores(suggestions) {
    return suggestions.map((s) => ({
        ...s,
        priorityScore: calculatePriority(s),
    }));
}
export function rankSuggestions(vault) {
    return [...withPriorityScores(vault)].sort((a, b) => (b.priorityScore ?? 0) - (a.priorityScore ?? 0));
}
