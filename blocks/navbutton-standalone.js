...
(function () {
  ...
  if (window.__BLOCK_NAVBUTTON_DEFINED__) return;
  window.__BLOCK_NAVBUTTON_DEFINED__ = true;
  ...
  function mount(props = {}, host) {
    ...
    root.textContent = "NavButton component (basic conversion - JSX not fully parsed)";
  ...
  if (window.BlockRegistry && typeof window.BlockRegistry.register === "function") {
    window.BlockRegistry.register("navbutton", {
      mount,
      unmount,
    });
  } else {
