        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-[#111114] border border-white/5 rounded-xl p-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-slate-400">Total Apps</span>
          ...
          <div className="bg-[#111114] border border-white/5 rounded-xl p-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-slate-400">Active Apps</span>
          ...
          <div className="bg-[#111114] border border-white/5 rounded-xl p-6">
            ...
            <div className="text-3xl font-bold">{recentApps}</div>
          </div>
        </div>
        ...
        <div className="bg-[#111114] border border-white/5 rounded-xl p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-slate-400 mb-4">No apps yet. Create your first app to get started!</p>
              <button
                onClick={handleCreateApp}
            ...
            <>
              {viewMode === 'grid' ? (
                <AppsGridView apps={apps} onAppClick={handleAppClick} />
              ) : (
                <AppsListView apps={apps} onAppClick={handleAppClick} />
              )}
            </>
          )}
        </div>
