...
(function () {
  ...
  if (window.__BLOCK_ICON_DEFINED__) return;
  window.__BLOCK_ICON_DEFINED__ = true;
  ...
  function mount(props = {}, host) {
    ...
    root.textContent = "Icon component (basic conversion - JSX not fully parsed)";
  ...
  if (window.BlockRegistry && typeof window.BlockRegistry.register === "function") {
    window.BlockRegistry.register("icon", {
      mount,
      unmount,
    });
  } else {
