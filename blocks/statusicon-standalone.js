...
(function () {
  ...
  if (window.__BLOCK_STATUSICON_DEFINED__) return;
  window.__BLOCK_STATUSICON_DEFINED__ = true;
  ...
  function mount(props = {}, host) {
    ...
    root.textContent = "StatusIcon component (basic conversion - JSX not fully parsed)";
  ...
  if (window.BlockRegistry && typeof window.BlockRegistry.register === "function") {
    window.BlockRegistry.register("statusicon", {
      mount,
      unmount,
    });
  } else {
