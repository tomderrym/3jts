...
(function () {
  ...
  if (window.__BLOCK_CATEGORIES_DEFINED__) return;
  window.__BLOCK_CATEGORIES_DEFINED__ = true;
  ...
  function mount(props = {}, host) {
    ...
    root.textContent = "CATEGORIES component (basic conversion - JSX not fully parsed)";
  ...
  if (window.BlockRegistry && typeof window.BlockRegistry.register === "function") {
    window.BlockRegistry.register("categories", {
      mount,
      unmount,
    });
  } else {
