// Standalone 176800569737158if8gy20 Block
...
export default function 176800569737158if8gy20({ title = '176800569737158if8gy20', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
