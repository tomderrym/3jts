// Standalone 1768004719516z3qyorkyz Block
...
export default function 1768004719516z3qyorkyz({ title = '1768004719516z3qyorkyz', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
