// Standalone 176800546207712ns019cd Block
...
export default function 176800546207712ns019cd({ title = '176800546207712ns019cd', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
