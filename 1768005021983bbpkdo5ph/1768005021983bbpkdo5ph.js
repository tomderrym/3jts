// Standalone 1768005021983bbpkdo5ph Block
...
export default function 1768005021983bbpkdo5ph({ title = '1768005021983bbpkdo5ph', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
