// Standalone 1768005734588a4jl1ajcx Block
...
export default function 1768005734588a4jl1ajcx({ title = '1768005734588a4jl1ajcx', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
