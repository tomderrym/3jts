// Standalone 1768005173131yasbsords Block
...
export default function 1768005173131yasbsords({ title = '1768005173131yasbsords', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
