// Standalone 1768005654651a0dp275ff Block
...
export default function 1768005654651a0dp275ff({ title = '1768005654651a0dp275ff', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
