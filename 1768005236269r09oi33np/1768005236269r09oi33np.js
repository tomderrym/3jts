// Standalone 1768005236269r09oi33np Block
...
export default function 1768005236269r09oi33np({ title = '1768005236269r09oi33np', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
