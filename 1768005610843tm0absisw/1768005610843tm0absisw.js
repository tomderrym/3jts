// Standalone 1768005610843tm0absisw Block
...
export default function 1768005610843tm0absisw({ title = '1768005610843tm0absisw', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
