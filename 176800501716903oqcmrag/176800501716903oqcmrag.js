// Standalone 176800501716903oqcmrag Block
...
export default function 176800501716903oqcmrag({ title = '176800501716903oqcmrag', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
