// Standalone 1768004325123kercpmapj Block
...
export default function 1768004325123kercpmapj({ title = '1768004325123kercpmapj', logo = 'http://localhost:3000/img/logo-cloud.092c568.png', items = [] }) {
